...
class VaspToDb(FiretaskBase):
    ...
    optional_params = ["calc_dir", "calc_loc", "parse_dos", "bandstructure_mode",
                       ...
                       "task_fields_to_push", "parse_chgcar", "parse_aeccar","parse_eigenval"]
    ...
    def run_task(self, fw_spec):
        ...
        drone = VaspDrone(additional_fields=self.get("additional_fields"),
                          ...
                          parse_eigenval=self.get("parse_eigenval", False),
...
class MagneticOrderingsToDB(FiretaskBase):
    ...
    def run_task(self, fw_spec):
        ...
        # get results for different saxis
        soc_task_label_regex = 'spin-orbit coupling'
        docs = list(
            mmdb.collection.find({ 
            "task_label": {"$regex": soc_task_label_regex},
            "wf_meta.wf_uuid": uuid},
            ["task_id", "output.energy_per_atom"])
            )
        
        soc_energies_list = [d["output"]["energy_per_atom"] for d in docs]
        mae_energy = max(soc_energies_list) - min(soc_energies_list)
        ...
        for d in docs:
            ...
            # TODO: get the energy of the FM state with SOC
            ...
            if ordering_origin == 'fm':
                summary["soc_energy_list"] = soc_energies_list
                summary["mae_energy"] = mae_energy
