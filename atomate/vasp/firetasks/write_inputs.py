...
from pymatgen.io.vasp.sets import MPStaticSet, MPNonSCFSet, MPSOCSet, MPHSEBSSet, MPNMRSet, MPHSE0StaticSet
...
@explicit_serialize
class WriteVaspHSE0FromPrev(FiretaskBase):
    """
    ...
    required_params = []
    optional_params = ["prev_calc_dir", "structure", "other_params"]

    def run_task(self, fw_spec):
        other_params = self.get("other_params", {})
        print(f"This is other_params:{other_params}")
        vis = MPHSE0StaticSet.from_prev_calc(
                                        prev_calc_dir=self.get("prev_calc_dir", "."),
